...
export default function AdminSidebar({ isMobileMenuOpen, setIsMobileMenuOpen }: { isMobileMenuOpen?: boolean; setIsMobileMenuOpen?: (open: boolean) => void } = {}) {
  ...
  return (
    <>
      ...
      <aside
        className={`h-screen w-64 fixed left-0 top-0 bg-surface/80 backdrop-blur-xl border-r border-outline-variant/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] flex flex-col py-8 z-50 shrink-0 transition-transform duration-300 ${
